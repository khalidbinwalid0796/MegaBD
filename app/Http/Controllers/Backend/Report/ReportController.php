...
class ReportController extends Controller
{
    ...
    public function TodayOrder()
    {
    	...
    	return view('backend.pages.report.today_order',compact('order'));
    }
    ...
    {
    	 return view('backend.pages.report.search');
    }
    ...
    public function searchByYear(Request $request)
    {
         ...
         return view('backend.pages.report.search_report',compact('order','total'));

    }

    //month delevered by searching
