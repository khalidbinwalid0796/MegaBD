...
<html lang="en">
  <head>
    ...
    <title>MegaBD Admin Panel</title>
    <!-- CSRF Token for ajax-->
    ...
    <!-- custom css(dataTables,select2,summernote,toaster,sweetalert) -->
  <link href="{{ asset('public/backend/lib/highlightjs/github.css')}}" rel="stylesheet">
  <link href="{{ asset('public/backend/lib/datatables/jquery.dataTables.css')}}" rel="stylesheet">
  <link href="{{ asset('public/backend/lib/select2/css/select2.min.css')}}" rel="stylesheet">
  <link href="{{ asset('public/backend/lib/summernote/summernote-bs4.css') }}" rel="stylesheet">
  <link rel="stylesheet" href="{{ asset('public/backend/lib/toaster/toastr.css')}}">
  <link rel="stylesheet" href="{{ asset('public/backend/lib/bootstrap-sweetalert/dist/sweetalert.css')}}">
  ...
  <body>
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Coupon & Rating Point</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('admin.coupon') }}" class="nav-link">Coupon</a></li>
          <li class="nav-item"><a href="{{ route('admin.rating') }}" class="nav-link">Rating User</a></li>
          <li class="nav-item"><a href="{{ route('rating.gift') }}" class="nav-link">Gift User</a></li>          
        </ul>
        @else
        @endif
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('post.categories') }}" class="nav-link">Category</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('admin.all.return') }}" class="nav-link">All Return</a>
            </li>
        </ul>
        @else
        @endif
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('admin.product.stock') }}" class="nav-link">Stock</a>
            </li>
        </ul>
        @else
        @endif
    ...
    <!-- custom js(dataTables,select2,summernote) -->
  ...
  <!-- custom js -->
  <script  src="{{ asset('public/backend/lib/toaster/toastr.min.js')}}"></script>
  <script  src="{{ asset('public/backend/lib/bootstrap-sweetalert/dist/sweetalert.min.js')}}"></script>
