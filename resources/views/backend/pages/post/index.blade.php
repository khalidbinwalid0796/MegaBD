    ...
    <div class="sl-mainpanel">
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h3 class="">Post List
            <a href="{{route('add.blogpost')}}" class="btn btn-sm btn-success" style="float: right;" data-toggle="modal" data-target="#modaldemo3"><i class="fa fa-plus-circle"></i>Add Post</a>
          </h3>
          <br>
