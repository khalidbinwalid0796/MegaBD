      ...
      <div class="sl-pagebody">
       ...
       <div class="sl-pagebody">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="form-group">
              <label for="profile_image">Image One (Main Thumbnail)</label>
            ...
            <div class="form-group">
             <div class="row">
                <div class="col-md-4">
                  <img id="showImage" src="{{(!empty($product->image_one))?URL::to($product->image_one) :url('public/products/no_image.png') }}" style="width: 100px;height: 110px;">
          ...
          <div class="col-lg-4">
            <div class="form-group">
              <label for="profile_image">Image Two</label>
            ...
            <div class="form-group">
             <div class="row">
                <div class="col-md-4">
                  <img id="showImage2" src="{{(!empty($product->image_two))?URL::to($product->image_two) :url('public/products/no_image.png') }}" style="width: 100px;height: 110px;">
          ...
          <div class="col-lg-4">
            <div class="form-group">
              <label for="profile_image">Image Three</label>
                  <input type="file" class="form-control" name="image_three" id="image_three" >
                  <input type="hidden" name="old_three" value="{{ $product->image_three }}">
            </div>
            <div class="form-group">
             <div class="row">
                <div class="col-md-4">
                  <img id="showImage3" src="{{(!empty($product->image_three))?URL::to($product->image_three) :url('public/products/no_image.png') }}" style="width: 100px;height: 110px;">
