            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
				            <img src="{{ (!empty($product->image_one))?URL::to($product->image_one) :url('public/products/no_image.png') }}" style="height: 80px; width: 80px;">
				        </label>
              </div>
              ...
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
				            <img src="{{ (!empty($product->image_two))?URL::to($product->image_two) :url('public/products/no_image.png') }}" style="height: 80px; width: 80px;">
				        </label>
              </div>
              ...
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
      				    <img src="{{ (!empty($product->image_three))?URL::to($product->image_three) :url('public/products/no_image.png') }}" style="height: 80px; width: 80px;">
      				</label>
              </div>
