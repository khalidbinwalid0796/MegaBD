...
<html lang="en">
<head>
    <title>MegaBD.com</title>
    <meta name="csrf" value="{{ csrf_token() }}">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="MegaBD.com">
...
<link rel="stylesheet" href="{{ asset('public/frontend/plugins/toaster/toastr.css')}}">
<link rel="stylesheet" href="{{ asset('public/frontend/plugins/bootstrap-sweetalert/dist/sweetalert.css')}}">
<!--  For Wishlist -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{url('/')}}">MegaBD<br>.com</a></div>
                        </div>
                    </div>
                            ...
                            <div class="header_search_content">
                                <div class="header_search_form_container">
                                    <form action="{{ route('product.search') }}" class="header_search_form clearfix" method="GET">
                                        <input type="search" required="required" class="header_search_input" name="search_key" placeholder="Search for products...">
...
<script  src="{{ asset('public/frontend/plugins/toaster/toastr.min.js')}}"></script>
<script  src="{{ asset('public/frontend/plugins/bootstrap-sweetalert/dist/sweetalert.min.js')}}"></script>
<!--  For Wishlist-->
