                ...
                <div class="main_nav_content d-flex flex-row">
                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            ...
                            <li class="hassubs">
                                <a href="#">{{ $row->category_name }}<i class="fas fa-chevron-right ml-auto"></i></a>
                                    @php
...
<div class="banner">
    ...
    <div class="container fill_height">
        <div class="row fill_height">
            <div class="banner_product_image"><img src="{{asset($main_slider->image_one)}}" height="359px;" width="421px;" alt=""></div>
            <div class="col-lg-5 offset-lg-4 fill_height">
                <div class="banner_content">
                    <h1 class="banner_text">{{ $main_slider->product_name }}</h1>
                    <div class="banner_price">
                        @if($main_slider->discount_price == NULL)
                          <h2>TK. {{ $main_slider->selling_price }}</h2>
                        @else
                         <span>TK. {{ $main_slider->selling_price }}</span>TK. {{ $main_slider->discount_price }}
                        @endif
                        
                    </div>
                    <div class="banner_product_name">{{ $main_slider->brand_name }}</div>
                    <div class="button banner_button"><a href="{{ url('product/details/'.$main_slider->id.'/'.$main_slider->product_name) }}">Shop Now</a></div>
                </div>
            </div>
        </div>
    </div>
