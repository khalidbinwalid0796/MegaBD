...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">{{ $subcat->category_name }}</h2>
						...
						<div class="product_grid row">
							...
							<div class="product_item is_new ">
								...
								<div class="product_content">
									...
									@else
									 <div class="product_price discount">TK. {{ $pro->discount_price }}<span>${{ $pro->selling_price }}</span></div>
									@endif
									...
									<div class="product_name"><div><a href="{{ url('product/details/'.$pro->id.'/'.$pro->product_name) }}" tabindex="0">{{ $pro->product_name }}</a></div></div>
						                    ...
						                    <button  
                                               class="addwishlist" data-id="{{ $pro->id }}" style="border-style: none;"> 
